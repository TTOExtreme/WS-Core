...
ClientEvents.on("usr/edt/pass", () => {
    ClientEvents.emit("usr/edt/pass/close");
    /**
    ...
    div.innerHTML = "" +
        "<table>" +
        "<tr><td id='move_menu_change_pass' class='move_menu' onmousedown=ClientEvents.emit(\"move_menu_down\",'change_pass_div')>&#9776;</td><td class='change_pass_label'><p class='change_pass_closeButton' onclick='ClientEvents.emit(\"usr/edt/pass/close\")'>X</p></td></tr>" +
