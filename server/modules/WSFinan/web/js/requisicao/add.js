...
ClientEvents.on("searchfornecedorwsfinan", () => {
    if (document.getElementById("wsfinan_add_fornecedor") != undefined) {
        ...
        ClientEvents.emit("SendSocket", "WSfinan/requisicao/clientes/lst", {
