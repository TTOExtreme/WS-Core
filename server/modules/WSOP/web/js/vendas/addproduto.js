ClientEvents.on("WSOP/produtos/add", () => {
    ...
    div.innerHTML = "" +
        ...
        "<tr><td colspan=2><div class='div_wsop_hist_table'><table><tr><td class='wsop_edt_label'>Nome:</td><td><input id='wsop_add_produto_name' type='text' value='" + data.name + "'></td></tr>" +
