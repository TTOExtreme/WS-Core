...
ClientEvents.emit("LoadExternal", [
    ...
    //"./module/WSOP/js/clientes/perm.js",
    //"./module/WSOP/js/clientes/disable.js",
    //"./module/WSOP/js/clientes/edt.js",
    //"./module/WSOP/js/clientes/grp.js",
...
window.UserList = class UserList {
    ...
    _init() {
        ...
        ClientEvents.on("system/added/users", () => { system_get_users(); ClientEvents.emit("system_mess", { status: "OK", mess: "Ciente Adicionado com Exito", time: 1000 }); });
        ClientEvents.on("system/removed/users", () => { system_get_users(); ClientEvents.emit("system_mess", { status: "OK", mess: "Ciente Removido com Exito", time: 1000 }); });
        ClientEvents.on("system/edited/users", () => { system_get_users(); ClientEvents.emit("system_mess", { status: "OK", mess: "Ciente Editado com Exito", time: 1000 }); });
    }
}
