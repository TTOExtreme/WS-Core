...
ClientEvents.on("wsop/os/produto/edt", (data) => {
    ...
    div.innerHTML = "" +
        ...
        "<tr style='display:none'><td class='wsop_edt_label'>Description:</td><td><input id='wsop_edt_products_desc' type='text' value='" + data.description + "'></td></tr>" +
        "<tr><td class='wsop_edt_label'>Descrição:</td><td id='wsop_edt_product_description' disabled>" + (data.obs).replace(new RegExp("&lt;", "g"), "<").replace(new RegExp("&gt;", "g"), ">") + "</textarea></td></tr>" +
