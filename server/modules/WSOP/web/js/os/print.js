...
ClientEvents.on("wsop/os/print", (data) => {
    ...
    div.innerHTML = "" +
        ...
        "<table style='width:100%;'>" +
        //os
        "<tr><td class='wsop_print_label'>Descrição:</td><td><p>" + data.description + "</p></td></tr>" +
        "</table><hr>" +
    ...
    htm += "<tr class='wsop_produto_item1'><td></td><td></td><td></td><td><b>TOTAL:</td><td>R$ " + total.toFixed(2) + "</td>"
