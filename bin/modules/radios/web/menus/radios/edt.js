...
function updateSubnet(data) {
    ...
    htm += "<tr><td><p style='text-align: right;vertical-align: middle;'>IP:</td><td><input id='add_in_ip' value='" + subnet.ip + "' disabled></td></tr>";
    ...
    htm += "</table></td></tr><tr>";
    htm += "<td><center><input type='button' value='Atualizar' onclick='RadiosAddSend()'></td>";
