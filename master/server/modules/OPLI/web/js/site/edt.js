...
ClientEvents.on("wsop/os/edt", (data) => {
    ...
    div.innerHTML = "" +
        "<table>" +
        "<tr class='menu_header'><td id='move_menu_wsop_add' class='move_menu' onmousedown=ClientEvents.emit(\"move_menu_down\",'wsop_edt_site_div')>&#9776;</td><td class='wsop_edt_label'><p class='closeButton' onclick='ClientEvents.emit(\"close_menu\", 'wsop_edt_site_div');'>X</p></td></tr>" +
